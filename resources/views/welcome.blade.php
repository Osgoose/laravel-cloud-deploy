        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-es-lg rounded-ee-lg lg:rounded-ss-lg lg:rounded-ee-none">
                    <h1 class="mb-1 font-medium">Bienvenid@ a Listopolis</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">Aquí podrás crear listas para organizar tus días y compartirlas con amigos y familiares.</p>
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute">
                            ...
                            <span>
                                Puedes ver
                                <a href="https://mislistas.rf.gd/dashboard" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ms-1">
                        ...
                        <li class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:start-[0.4rem] before:absolute">
                            ...
                            <span>
                                o también puedes ver
                                <a href="https://mislistas.rf.gd/shared-lists" class="inline-flex items-center space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433] ms-1">
...
<svg class="w-full text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
     viewBox="0 0 438 104" xmlns="http://www.w3.org/2000/svg" fill="none">
  <defs>
    <!-- Barrido ancho; parte MUY fuera a la izquierda -->
    <linearGradient id="listopolis-sweep-a" x1="-200%" y1="0%" x2="-160%" y2="0%">
      <stop offset="0%" stop-color="currentColor"/>
      <stop offset="30%" stop-color="currentColor"/>
      <stop offset="50%" stop-color="#ffffff" stop-opacity="1"/>
      <stop offset="70%" stop-color="currentColor"/>
      <stop offset="100%" stop-color="currentColor"/>
      <!-- La animación ya corre, pero no será visible hasta que suba la opacidad del rect -->
      <animate attributeName="x1" values="-200%;140%" dur="3s" repeatCount="indefinite"/>
      <animate attributeName="x2" values="-160%;180%" dur="3s" repeatCount="indefinite"/>
    </linearGradient>

    <!-- Segunda pasada desfasada -->
    <linearGradient id="listopolis-sweep-b" x1="-200%" y1="0%" x2="-160%" y2="0%">
      <stop offset="0%" stop-color="currentColor"/>
      <stop offset="30%" stop-color="currentColor"/>
      <stop offset="50%" stop-color="#ffffff" stop-opacity="1"/>
      <stop offset="70%" stop-color="currentColor"/>
      <stop offset="100%" stop-color="currentColor"/>
      <animate attributeName="x1" values="-200%;140%" dur="3s" begin="1.5s" repeatCount="indefinite"/>
      <animate attributeName="x2" values="-160%;180%" dur="3s" begin="1.5s" repeatCount="indefinite"/>
    </linearGradient>

    <!-- Fallback Safari con translate desde fuera -->
    <linearGradient id="listopolis-sweep-a-t" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="currentColor"/>
      <stop offset="30%" stop-color="currentColor"/>
      <stop offset="50%" stop-color="#ffffff" stop-opacity="1"/>
      <stop offset="70%" stop-color="currentColor"/>
      ...
      <animateTransform attributeName="gradientTransform" type="translate"
                        values="-2 0; 1 0" dur="3s" repeatCount="indefinite"/>
    </linearGradient>
    <linearGradient id="listopolis-sweep-b-t" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%" stop-color="currentColor"/>
      <stop offset="30%" stop-color="currentColor"/>
      <stop offset="50%" stop-color="#ffffff" stop-opacity="1"/>
      <stop offset="70%" stop-color="currentColor"/>
      <stop offset="100%" stop-color="currentColor"/>
      <animateTransform attributeName="gradientTransform" type="translate"
                        values="-2 0; 1 0" dur="3s" begin="0s" repeatCount="indefinite"/>
    </linearGradient>
    ...
    <mask id="text-mask">
      ...
      <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle"
            ...
            font-weight="800" font-size="64" letter-spacing="2" fill="white">
        LISTOPOLIS
      </text>
    </mask>
  </defs>

  <!-- Base: siempre visible, color actual -->
  <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle"
        font-family="system-ui, -apple-system, Segoe UI, Roboto, Inter, Arial, sans-serif"
        font-weight="800" font-size="64" letter-spacing="2" fill="currentColor">
    LISTOPOLIS
  </text>

  <!-- Fallback Safari: mismas capas con gradiente transformado -->
  <rect width="100%" height="100%" mask="url(#text-mask)" fill="url(#listopolis-sweep-a-t)" opacity="0">
    <animate attributeName="opacity" values="0;1" begin="0.25s" dur="0.2s" fill="freeze"/>
  </rect>
  <rect width="100%" height="100%" mask="url(#text-mask)" fill="url(#listopolis-sweep-b-t)" opacity="0">
    <animate attributeName="opacity" values="0;1" begin="1.75s" dur="0.2s" fill="freeze"/>
  </rect>
</svg>
...
<svg class="w-[448px] max-w-none relative -mt-[4.9rem] -ms-8 lg:ms-0 lg:-mt-[6.6rem] dark:hidden"
     viewBox="0 0 440 376" xmlns="http://www.w3.org/2000/svg" fill="none">
  <g class="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:opacity-0 starting:translate-y-4">
    <!-- Centro exacto X=220, alto Y=250, escala MUY grande -->
    <g transform="translate(220, 220) scale(12)" class="text-white">
      <!-- Centrado por la mitad del icono 24x24 -->
      <g transform="translate(-12,-12)" fill="none" stroke="currentColor" stroke-width="0.9" stroke-linecap="round" stroke-linejoin="round">
        ...
        <path d="M10.5 11H17M7 11h.5M7 7.5h.5m-.5 7h.5m3-7H17m-6.5 7H17"/>
      </g>
    </g>
  </g>
</svg>
